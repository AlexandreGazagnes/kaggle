...
# This my fisrt work about Titanic competition
# 
# 
...
####################################################
	...
	# cat_enc = CategoricalEncoder(encoding="ordinal", categories="auto")
	# df["Sex"] = cat_enc.fit(df["Sex"])
...
df["Embarked"] = df["Embarked"].apply(embarqued).astype("int8")

print()

df["Fare"] = pd.cut(df["Fare"], 10, labels=range(10,0,-1) )

print(df["Sex"].head(10))
print(df["Embarked"].head(10))
print(df["Fare"].head(10))

# df["Age"] = np.ceil(df["Age"]).astype("int16")
# print(df["Age"].head())
